...
return {
...
},
  {
    ...
    highlight_new_as_changed = false  --以与更改变量相同的方式突出显示新变量（如果highlight_changed_variables）
    ...
    virt_text_win_col = nil --将虚拟文本放置在固定窗口列（从第一个文本列开始），
    ...
    keys = {
      ...
      { "<F9>", "<cmd>PBToggleBreakpoint<CR>", desc = "ToggleBreakpoint" },
